...
// Mongoose middleware function that is executed before a user document is saved to the database.
 It specifically runs before the save operation is performed on a User instance. In Mongoose, middleware functions allow you to execute logic before or after certain events, such as saving, updating, or removing documents.