...
UserSchema.methods.createRefresh = function (uuid: string): string {
  ...
  // the rest of our TS application has no idea about the various fields and methods available to this schema. The fields that we defined directly in UserSchema right now are only visible to MongoDB through mongoose but they are not at all exposed to the rest of our TS app.