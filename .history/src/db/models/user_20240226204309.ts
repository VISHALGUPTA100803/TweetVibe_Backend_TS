...
UserSchema.methods.createRefresh = function (uuid: string): string {
  ...
  // to this schema. The fields that we defined directly in UserSchema right now are only visible to MongoDB through mongoose but they are not at all exposed to the rest of our TS app.